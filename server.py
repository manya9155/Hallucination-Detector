...
TMDB_API_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhMTgyZjI1Njg0Nzc1ZjlkYTdjNDUyMzQ1MGVkYTEwNCIsIm5iZiI6MTc1ODg2MjY4OC4wOCwic3ViIjoiNjhkNjFkNjA3ZDExMTU0YmM3ZDNjZDM0Iiwic2NvcGVzIjpbImFwaV9yZWFkIl0sInZlcnNpb24iOjF9.lsBLFLRbb8mgUNWfWf1lR16P8KLArfvcPZGI_frqnCGtU"
OMDB_API_KEY = "a6f7938d"

# Configure the old-style SDK
    ...
    for claim in claims:
        ...
        if attr in ["director", "actor"]:
            ...
            if wikidata:
                ...
                if val_lower in wd_names: matched = True
    ...
    try:
        ...
        for res in results:
            ...
            summary_lines.append(
                f"{claim['attribute']} = {claim['value']} → {res['status']} (sources: {', '.join(res['sources_used'])})"
            )
